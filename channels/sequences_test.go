...
func TestTee(t *testing.T) {
        Convey("Tee tests", t, func() {
			Convey("When done is already closed", t, func() {
				f1 := &foo{
					SomeString: "foo 1",
					SomeFloat: 0.42,
				}
			...
			Convey("When input channel is already closed", t, func() {
				f1 := &foo{
					SomeString: "foo 1",
					SomeFloat: 0.42,
				}
			...
			Convey("When operating normally two sent values are received on both channels -- happy path", t, func() {
				f1 := &foo{
					SomeString: "foo 1",
					SomeFloat: 0.42,
				}
